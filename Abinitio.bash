...
Description:
------------
This is a Bash script that automatically sets the correct files and folders to run Rosetta Abinitio (default for 25,000 decoys) followed by Clustering (lowest 200 scoring decoys) followed by plotting the computation result. This script is to be run on a HPC (High Preformace Computer) that uses PBS as its job scheduler.
...
2. It goes without saying that you need to download and compile the Rosetta modeling software link[https://www.rosettacommons.org] to be able to use this script. Good understanding of how Abinitio works in Rosetta will GREATLY help you modify this script to accomodate your HPC and your specific needs.
...
10. Here is a video[youtube.com/] that explains the script and how to modify it.
COMMENT
#---------------------------------------------------------------------------------------------------------------
